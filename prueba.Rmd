...
- Densidad poblacional: ``r sum(Base_zona$POBTOT)/sum(round(area_km2, 2))`` Hab/Km^2.
...
- Relación M-F: ``r sum(Base_zona$REL_H_M)/nrow(Base_zona) ``
...
- Porcentaje de viviendas con servicios básicos1:
- Porcentaje de viviendas sin bienes2: 
- Porcentaje de ocupantes en viviendas particulares que disponen de energía eléctrica, agua entubada y drenaje: 
- Porcentaje de viviendas particulares habitadas que no disponen de refrigerador ni lavadora: 
- Porcentaje de viviendas particulares habitadas sin tecnologías de la información y la comunicación (TIC): 
...
- Porcentaje de población de 12 años y más no económicamente activa: 
- Porcentaje de población de 12 años y más ocupada sin escolaridad:
- Porcentaje de población de 12 años y más ocupada con al menos un grado aprobado en primaria: 
- Porcentaje de población de 12 años y más ocupada con secundaria o equivalente incompleta: 
- Porcentaje de población de 12 años y más ocupada con al menos un grado aprobado en educación media superior: 

#### Educación

Según los datos del Censo de Población y Vivienda 2020, la educación del municipio se caracteriza por los siguientes estadísticos:

- Porcentaje de población de 15 años y más sin escolaridad: 
- Porcentaje de población de 15 años y más con educación básica completa: 
- Porcentaje de población masculina de 18 años y más con al menos un grado aprobado en educación media superior:
- Porcentaje de población de 25 años y más con al menos un grado aprobado en educación superior: 
